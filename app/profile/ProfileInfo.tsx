...
export default function ProfileInfo({ profile, user, children }: { profile: { full_name?: string, username?: string, avatar_url?: string } | null, user: { email?: string }, children: React.ReactNode }) {
