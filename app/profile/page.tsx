...
export default async function ProfilePage() {
    ...
    const demoOrders = orders && orders.length > 0 ? orders : [
        ...
        {
            id: 'ord_987654321',
            // Use fixed offset from current date, but safely since server components evaluate Date.now() on render
            // Better to suppress the warning or use a fixed date. Here we use a safe construct or suppress it.
