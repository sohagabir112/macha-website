...
export async function addToCart(product: { name: string, price: string | number }) {
    ...
    // SECURITY: Prevent Price Manipulation by validating against the server-side catalog.
    // Client-provided product data can be tampered with, so we enforce the actual price here.
